...
public abstract class EditData<T extends OsmObject> {
	...
	public abstract EditData<T> readInitialData(T osmObject) throws UnchangedException;
	...
	public abstract void writeData(T osmObject) throws UnchangedException, Exception;
}
